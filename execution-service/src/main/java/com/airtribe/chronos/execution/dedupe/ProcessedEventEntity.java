...
public class ProcessedEventEntity {
    ...
    @Id @Column(name = "consumer_group", length = 100) private String consumerGroup;
    ...
    public ProcessedEventEntity(String eventId, String consumerGroup) {
        this.eventId = eventId; this.consumerGroup = consumerGroup; this.processedAt = Instant.now();
    }
    public static class Pk implements Serializable {
        private String eventId; private String consumerGroup;
        public Pk() {}
